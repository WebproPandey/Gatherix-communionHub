...
const MommentCard = ({ height, width, title, description, image }) => {
  return (
    <div 
      className="border-[1px] perspective-1000 p-4 bg-white shadow-md rounded-2xl"
      style={{ height, width }}
    >
      {/* Image Section */}
      <div 
      ...
      <div className="content h-[40%] w-full flex flex-col justify-center items-center text-center p-4">
        ...
        <p className="text-[1.2vw] text-gray-600 mt-2">{description}</p>
      </div>
    </div>
  );
};
